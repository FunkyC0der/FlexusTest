...
namespace Sisus.Init
{
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="NetworkBehaviour{TArgument}"/> receive the argument
	...
	public abstract class NetworkBehaviour<TArgument> : NetworkBehaviourBase, IInitializable<TArgument>
	{
		/// <summary>
