...
namespace Sisus.Init
{
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="NetworkBehaviour{TFirstArgument, TSecondArgument}"/> receive the arguments
	...
	public abstract class NetworkBehaviour<TFirstArgument, TSecondArgument> : NetworkBehaviourBase, IInitializable<TFirstArgument, TSecondArgument>
	{
		/// <summary>
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<NetworkBehaviour<TFirstArgument, TSecondArgument>, TFirstArgument, TSecondArgument>(this, memberName, value);
			}
		}
