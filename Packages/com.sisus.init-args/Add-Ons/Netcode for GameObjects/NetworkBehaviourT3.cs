...
namespace Sisus.Init
{
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="NetworkBehaviour{TFirstArgument, TSecondArgument, TThirdArgument}"/> receive the arguments
	...
	public abstract class NetworkBehaviour<TFirstArgument, TSecondArgument, TThirdArgument> : NetworkBehaviourBase, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument>
	{
		/// <summary>
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<NetworkBehaviour<TFirstArgument, TSecondArgument, TThirdArgument>, TFirstArgument, TSecondArgument, TThirdArgument>(this, memberName, value);
			}
		}
