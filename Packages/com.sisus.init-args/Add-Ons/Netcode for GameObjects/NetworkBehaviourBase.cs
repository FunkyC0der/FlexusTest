...
{
	/// <summary>
	/// Base class for all <see cref="NetworkBehaviour{T}">NetworkBehaviour{T...}</see> classes.
	/// <para>
	/// Extends the <see cref="NetworkBehaviour"/> class with the ability to automatically
	/// try and retrieve services that the component depends on during the Awake event.  
	/// </para>
	/// <para>
	/// You usually want to derive from a generic NetworkBehaviour{T...} class instead of this one.
	...
	/// </para>
	/// </summary>
	public abstract class NetworkBehaviourBase : NetworkBehaviour, IInitializable
	#if UNITY_EDITOR
